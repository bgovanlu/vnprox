...
// pveGateway realizes every change.PVEGateway method (sdn.apply, and —
// T-502 — the full fw.* op family) through the user's own *pve.Client.
type pveGateway struct {
	client *pve.Client
}

func (g *pveGateway) ApplySDN(ctx context.Context) error {
