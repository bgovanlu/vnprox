...
func runDaemon(ctx context.Context, configPath string, logger *slog.Logger) error {
	...
	findingsEngine = setupFindings(graph, driftSvc, topoSvc, metricsSampler, mgmtAdapter, corosyncAdapter, fwAnalyticsAdapterVal, scheduleAdapter, latMeshSvc, findingsNotifier, topoSvc, ipamConcrete, simDivergenceRepo, logger)
