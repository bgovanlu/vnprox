...
var Operations = map[string]Operation{
	...
	"GET /api/v1/snmp/counters":               {Summary: "Return polled SNMP switch-port counters.", Tag: "snmp", Auth: AuthSession},
	"GET /api/v1/snmp/targets":                {Summary: "List configured SNMP switch-counter poll targets.", Tag: "snmp", Auth: AuthSession},
	"PUT /api/v1/snmp/targets/{chassisId}":    {Summary: "Create or update a switch's SNMP poll config.", Tag: "snmp", Auth: AuthSession},
	"DELETE /api/v1/snmp/targets/{chassisId}": {Summary: "Remove a switch's SNMP poll config.", Tag: "snmp", Auth: AuthSession},
