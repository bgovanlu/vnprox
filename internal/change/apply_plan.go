...
// multi-node case.
//
// It returns *ErrUnsupportedOp for any op the executor cannot run yet
// (guest/ipam families — sdn.zone/vnet/subnet.* is executable as of T-402,
// fw.* is executable as of T-502), so an un-executable changeset is refused
