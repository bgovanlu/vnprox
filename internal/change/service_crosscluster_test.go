...
// hasFindingCode lives in validate_switch_test.go (same package): it reports
// whether findings contains an error with the given code. codeCrossClusterRef
// is emitted at SeverityError, so that stricter check applies here too.
