...
| `Bridge` | name, kind (linux|ovs), ports []Ref, vlanAware bool, vids []VidRange, stp, mtu, addresses []CIDR, gateway, comments, pending |
| `VlanIface` | name, parent Ref, vid, addresses, mtu, pending |
