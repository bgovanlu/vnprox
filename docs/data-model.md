...
CREATE TABLE k8s_clusters (            -- T-1501: internal/store/migrations/0011_k8s_clusters.sql
  id TEXT PRIMARY KEY,                 -- ULID
  name TEXT NOT NULL,
